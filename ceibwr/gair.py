...
class Gair(TreeNode):
    ...
    def __init__(self, s, parent=None):
        ...
        while idx < len(s):
            ...
            # mae angen dileu atalnodau o'r cnewyllyn
            # TODO: delio gyda atalnodau unigol, espec. '-'
            
            cwlwm = cnew.lower()
            cwlwm = ''.join([c if c in llafariaid else '' for c in cwlwm])
            ...
            if len(cwlwm) == 2 and (
                cwlwm in deuseiniaid["hiatus"] or
            ...
            key = ''.join([hir2byr[char] if char in hir2byr else char for char in cwlwm])
