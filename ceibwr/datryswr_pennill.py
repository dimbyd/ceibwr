...
def datryswr_pennill(pennill, fesul_llinell=False):
    ...
    for idx, dat in enumerate(dat_seq):
        if type(dat) in [CroesBengoll, TrawsBengoll]:
...
def main():
    ...
    for key in [
        ...
        for s in profion[key]:
            ...
            # print()
            # print('ODLAU:')
            # if hasattr(dat, 'odlau') and dat.odlau:
            #     # print(type(dat.odlau))
            #     print('odlau:', dat.odlau)
            #     print('odrep:', dat.show_odlau_str())
            # else:
            #     print('dim odlau')
            # print()
            # print(dat.show_table())
            # print()
            # print(dat.show_table(fancy=True, cmap=cmap))
            # print(pennill)
            # print()
            # print('---------------')
            # print(dat.show(cmap=cmap))
