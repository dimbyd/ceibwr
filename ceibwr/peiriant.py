...
odlau_file = settings.DATABASES['default']['ODLIADUR']     # json
geirfa_file = settings.DATABASES['default']['GEIRFA']      # txt
cerddi_root = settings.CERDDI_ROOT
...
class Peiriant(object):
    ...
    def demo_llinellau(self):
        ...
        # darllen profion o'r ffeil json
        # import json
        # from ceibwr.settings import DATA_ROOT
        # input_filename = os.path.join(DATA_ROOT, 'profion/profion_llinellau.json')
        # with open(input_filename, 'r') as file:
        #     profion = json.load(file)
